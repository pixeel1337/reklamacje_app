...
def otworzFormularzDodawania(parent_window, callback_odswiez=None):
    ...
    # KAFELEK 1: ROLA I OSOBA REJESTRUJĄCA
    ...
    # KAFELEK 2: SZCZEGÓŁY ZGŁOSZENIA
    ...
    def obsluzZapis():
        ...
        # 1. Zapis do bazy danych i podfolderu Reklamacje_Dane
        nowe = {
        ...
        # 2. Wysyłka maila do wskazanego dyrektora w osobnym wątku
        threading.Thread(
            target=wyslijMaila,
            kwargs={
                "odbiorca": dyrektor,
...
if __name__ == "__main__":
    root = tk.Tk()
    root.title("Test formularza")
    root.geometry("300x100")
    otworzFormularzDodawania(root)
    root.mainloop()